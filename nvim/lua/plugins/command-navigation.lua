...
--
--FIXME: Break this down into smaller files or separate fns or something...
...
map("n", "<Leader>n", ":Yazi <CR>")  -- all files & folders
map("n", "<Leader>N", ":Broot <CR>") -- all files & folders (in iterm need to hold shift AFTER space)
...
return {
  {
    ...
    dependencies = {
      ...
      --   name = "telescope-ctrl-t.lua", -- my own
      --   dir = "~/.dotfiles/nvim/lua/",
      --   init = require("telescope-ctrl-t").init,
      --   dependencies = {
      --     "nvim-telescope/telescope.nvim",
      --     "nvim-lua/plenary.nvim",
      ...
      -- {
      --   -- "telescope-ctrl-t", -- my own
      --   import = "plugins.telescope-ctrl-t", -- my own
      --   init = require("telescope-ctrl-t").init,
      --   dependencies = {
      --     "nvim-telescope/telescope.nvim",
      --     "nvim-lua/plenary.nvim",
    ...
    config = function()
      ...
      -- seems to work on it's own by being part of the main spec...
      ...
      -- any code after this block isn't running???
      local builtin = require("telescope.builtin")
      ...
      -- FIXME: investigate more. This is busted!!!
      -- vim.keymap.set("n", "<leader>b", function()
      --   print('hiiii')
      --   -- builtin.buffers({ layout_strategy = "vertical", layout_config = { width = 0.7, mirror = true } })
      --   builtin.buffers({
      ...
      -- commenting for now. I like the fzf-lua one more
